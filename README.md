...
## ➡️xray和rad下载地址
- 点击跳转[xray](https://github.com/chaitin/xray/releases/tag/1.9.11)下载地址
- 点击跳转[rad](https://github.com/chaitin/rad/releases/tag/1.0)下载地址
  
## ⬆️更新日志
```
- 【2023.12.04】 修复第二次扫描时候，无法生成扫描文件的bug
- 【2023.12.14】 更新rad模块的ui界面
- 【2023.12.25】 优化UI界面按钮状态，以及MD5撞库匹配速度
- 【2024.01.11】 增加命令行输出的颜色，更醒目
```
